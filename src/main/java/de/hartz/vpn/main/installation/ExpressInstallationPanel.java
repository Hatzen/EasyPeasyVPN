...
public class ExpressInstallationPanel extends InstallationPanel {
    ...
    private void installOnLinuxWithoutPackageManager() throws Exception {
        ...
        File source = GeneralUtilities.getResourceAsFile("installer/openvpn-latest-stable.tar.gz");
    ...
    private void startWindowsInstallation() {
        try {
            ...
            */
            ...
            File source = GeneralUtilities.getResourceAsFile("installer/openvpn-install-2.4.2-I601.exe");
            File dest = new File(GeneralUtilities.getTempDirectory(), source.getName());
